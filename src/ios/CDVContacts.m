            ...
            if (!filter || [filter isEqualToString:@""]) {
                ...
                if (foundRecords && ([foundRecords count] > 0)) {
                    ...
                    for (int k = 0; k < xferCount; k++) {
                        CDVContact* xferContact = [[CDVContact alloc] initFromABRecord:(__bridge_transfer ABRecordRef)[foundRecords objectAtIndex:k]];
                ...
                for (int j = 0; j < testCount; j++) {
                    CDVContact* testContact = [[CDVContact alloc] initFromABRecord:(__bridge_transfer ABRecordRef)[foundRecords objectAtIndex:j]];
                    if (testContact) {
